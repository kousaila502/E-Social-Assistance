...
// Add specific configuration for user documents - FIX: Use singleDocumentUpload instead of undefined 'upload'
const uploadUserDocument = wrapUploadMiddleware(singleDocumentUpload.single('document'));
