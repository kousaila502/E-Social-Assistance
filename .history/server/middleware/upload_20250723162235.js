...
// Add specific configuration for user documents - FIX: Use singleDocumentUpload directly
const uploadUserDocument = singleDocumentUpload;
...
module.exports = {
  ...
  cleanupFiles,
  handleMulterError,
  uploadUserDocument: wrapUploadMiddleware(uploadUserDocument)
};
