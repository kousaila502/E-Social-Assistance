  ...
  useEffect(() => {
    reset({
      ...
      personalInfo: {
        ...
        emergencyContact: {
          name: user.personalInfo?.emergencyContact?.name || '',
          relationship: user.personalInfo?.emergencyContact?.relationship || '',
          phoneNumber: user.personalInfo?.emergencyContact?.phoneNumber || '',
        },
      },
      economicInfo: {
          ...
          <div className="bg-gray-50 rounded-lg p-6">
            ...
            <div className="space-y-3">
              <div className="flex items-center">
                ...
                <span className="text-sm font-medium text-gray-900">
                  {user.personalInfo?.emergencyContact?.name || 'Not provided'}
                </span>
              </div>
              <div className="flex items-center">
                <span className="text-sm text-gray-600 w-24 ml-7">Relationship:</span>
                <span className="text-sm font-medium text-gray-900">
                  {user.personalInfo?.emergencyContact?.relationship || 'Not provided'}
                </span>
              </div>
              <div className="flex items-center">
                <Phone className="h-4 w-4 text-gray-400 mr-3" />
                ...
                <span className="text-sm font-medium text-gray-900">
                  {user.personalInfo?.emergencyContact?.phoneNumber || 'Not provided'}
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 gap-4">
              ...
              <div>
                ...
                <input
                  type="tel"
                  {...register('personalInfo.emergencyContact.phoneNumber')}
                  className="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                />
              </div>
            </div>
...
export default ProfileForm;block text-sm font-medium text-gray-700">Street Address</label>
                <input
                  type="text"
