...
const DocumentManager: React.FC<DocumentManagerProps> = ({ userId }) => {
  ...
  const documentTypes = [
    { value: 'nationalIdCard', label: 'National ID Card', required: true },    // FIXED: changed 'key' to 'value'
    { value: 'incomeProof', label: 'Income Proof', required: false },
    { value: 'familyComposition', label: 'Family Composition', required: false },
    { value: 'residenceProof', label: 'Residence Proof', required: false },
  ] as const;
