...
// Manual icon components to avoid lucide-react dependency issues
...
const DocumentManager: React.FC<DocumentManagerProps> = ({ userId }) => {
  ...
  const [selectedDocumentType, setSelectedDocumentType] = useState<Document['type']>('nationalIdCard');
  ...
  const getVerificationIcon = (status: Document['verificationStatus']) => {
    switch (status) {
      case 'verified':
        ...
        {documents.length === 0 ? (
          ...
          <div className="divide-y divide-gray-200">
            {documents.map((document) => (
              <div key={document._id} className="px-6 py-4">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center space-x-2">
                        ...
                        <span className={getVerificationBadge(document.verificationStatus)}>
                      ...
                      {document.verificationNotes && (
                        <p className="text-xs text-gray-600 mt-1">
                          <strong>Note:</strong> {document.verificationNotes}
                        </p>
                      )}
                    </div>
                  </div>
