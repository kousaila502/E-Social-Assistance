...
const DocumentManager: React.FC<DocumentManagerProps> = ({ userId }) => {
  ...
  const documentTypes = [
    { key: 'nationalIdCard', label: 'National ID Card', required: true },
    { key: 'incomeProof', label: 'Income Proof', required: false },
    { key: 'familyComposition', label: 'Family Composition', required: false },
    { key: 'residenceProof', label: 'Residence Proof', required: false },
  ] as const;
