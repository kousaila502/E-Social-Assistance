...
const UserDetails: React.FC<UserDetailsProps> = ({
  ...
  // Mock user activity - in real app, this would come from API
  const mockActivity: UserActivity[] = [
    {
      id: '1',
      type: 'request_submitted',
      description: 'Submitted medical assistance request',
    ...
    },
    {
      ...
      description: 'Uploaded medical records',
    ...
    },
    {
      ...
      description: 'Housing assistance request approved',
      timestamp: '2024-01-18T11:15:00Z',
      metadata: {
        requestTitle: 'Rent Payment Assistance',
        amount: 1000
      }
    },
    {
      ...
      description: 'Received payment for housing assistance',
              ...
              <div className="bg-gray-50 rounded-lg p-4 mb-6">
                ...
                <div>
                  <div className="flex justify-between text-sm text-gray-600 mb-1">
                    ...
                    <span>{user.eligibility.score}/100</span>
                  </div>
                  <div className="w-full bg-gray-200 rounded-full h-2">
                    <div
                      className={`h-2 rounded-full ${
                        user.eligibility.score >= 70 ? 'bg-green-600' :
                        user.eligibility.score >= 50 ? 'bg-yellow-600' : 'bg-red-600'
                      }`}
                      style={{ width: `${user.eligibility.score}%` }}
                    />
                  </div>
                </div>
              </div>
