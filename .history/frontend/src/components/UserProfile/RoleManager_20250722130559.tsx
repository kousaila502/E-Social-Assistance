                  ...
                  <div className="space-y-2">
                    {group.permissions.map((permission) => {
                      ...
                      return (
                        <div
                          key={permission.key}
                          className={`flex items-start p-3 rounded-lg border ${hasAccess
                        ...
                        >
                          ...
                          <div className="ml-3 flex-1">
                            <p className={`font-medium ${hasAccess ? 'text-green-900' : 'text-gray-900'
                              }`}>
                              {permission.label}
                            </p>
                            <p className={`text-sm ${hasAccess ? 'text-green-700' : 'text-gray-600'
                              }`}>
