...
const CreateBudgetPoolModal: React.FC<CreateBudgetPoolModalProps> = ({
    ...
    useEffect(() => {
        if (editingBudgetPool) {
            setFormData({
                ...
                program: editingBudgetPool.program,
                budgetPeriod: {
    ...
    const validateForm = (): boolean => {
        ...
        // Program Validation
        if (!formData.program.name?.trim()) newErrors.programName = 'Program name is required';
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <InputField
                                            ...
                                            onChange={(value) => setFormData(prev => ({ 
                                                ...prev, 
                                                program: { ...prev.program, name: value as string } 
                                            }))}
                                            ...
                                            errors={errors}
                                            icon={CogIcon}
                                            description="Associated program for this budget pool"
                                        />
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="grid grid-cols-1 gap-6">
                                    <InputField
                                        ...
                                        type="number"
                                        value={formData.allocationRules.maxAmountPerRequest}
                                        onChange={(value) => setFormData(prev => ({
                                            ...prev,
                                            allocationRules: { ...prev.allocationRules, maxAmountPerRequest: value as number }
                                        }))}
                                        placeholder="0.00"
                                        required
                                        min={0.01}
                                    ...
                                    <InputField
                                        ...
                                        type="number"
                                        value={formData.allocationRules.autoApprovalLimit}
                                        onChange={(value) => setFormData(prev => ({
                                            ...prev,
                                            allocationRules: { ...prev.allocationRules, autoApprovalLimit: value as number }
                                        }))}
                                        placeholder="0.00"
                                        min={0}
                                        step="0.01"
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <InputField
                                        ...
                                        type="number"
                                        value={formData.alertThresholds.lowBalanceWarning}
                                        onChange={(value) => setFormData(prev => ({
                                            ...prev,
                                            alertThresholds: { ...prev.alertThresholds, lowBalanceWarning: value as number }
                                        }))}
                                        placeholder="20"
                                        required
                                        min={1}
                                    ...
                                    <InputField
                                        ...
                                        type="number"
                                        value={formData.alertThresholds.criticalBalanceAlert}
                                        onChange={(value) => setFormData(prev => ({
                                            ...prev,
                                            alertThresholds: { ...prev.alertThresholds, criticalBalanceAlert: value as number }
                                        }))}
                                        placeholder="10"
                                        required
                                        min={1}
                                ...
                                <div className="grid grid-cols-1 gap-6">
                                    <InputField
                                        ...
                                        type="number"
                                        value={formData.alertThresholds.expirationWarning}
                                        onChange={(value) => setFormData(prev => ({
                                            ...prev,
                                            alertThresholds: { ...prev.alertThresholds, expirationWarning: value as number }
                                        }))}
                                        placeholder="30"
                                        required
                                        min={1}
                                ...
                                <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                                        ...
                                        <div>
                                            ...
                                            <span className="ml-2 font-medium">{formData.program.name || 'Not specified'}</span>
                                        </div>
                                        <div>
                                        ...
                                        <div>
                                            ...
                                            <span className="ml-2 font-medium">{budgetService.formatCurrency(formData.allocationRules.maxAmountPerRequest)}</span>
                                        </div>
                                        <div>
                                            <span className="text-gray-600">Auto-Approval Limit:</span>
                                            <span className="ml-2 font-medium">{budgetService.formatCurrency(formData.allocationRules.autoApprovalLimit)}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
