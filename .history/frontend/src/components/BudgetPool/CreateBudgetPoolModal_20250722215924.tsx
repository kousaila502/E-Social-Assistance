...
const CreateBudgetPoolModal: React.FC<CreateBudgetPoolModalProps> = ({
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const savedBudgetPool = response.budgetPool;
                                ...
                                <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                                        ...
                                        <div>
                                            ...
                                            <span className="ml-2 font-medium">{formData.program.type}</span>
                                        </div>
                                        <div>
                                        ...
                                        <div>
                                            ...
                                            <span className="ml-2 font-medium">${(formData.allocationRules?.maxAmountPerRequest || 0).toLocaleString()}</span>
                                        </div>
                                        <div>
                                            <span className="text-gray-600">Auto-Approval Limit:</span>
                                            <span className="ml-2 font-medium">${(formData.allocationRules?.autoApprovalLimit || 0).toLocaleString()}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
