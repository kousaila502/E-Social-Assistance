...
import { BudgetPool, CreateBudgetPoolData } from '../../config/apiConfig';
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <InputField
                                        ...
                                        name="lowBalance"
                                        type="number"
                                        value={formData.alertThresholds.lowBalance}
                                        onChange={(value) => setFormData(prev => ({
                                            ...prev,
                                            alertThresholds: { ...prev.alertThresholds, lowBalance: value as number }
                                        }))}
                                        placeholder="20"
                                        required
                                        min={1}
