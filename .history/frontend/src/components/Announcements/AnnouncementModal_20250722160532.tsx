...
const CreateAnnouncementModal: React.FC<CreateAnnouncementModalProps> = ({
    ...
    useEffect(() => {
        if (editingAnnouncement) {
            ...
            let targetAudienceValue = 'all'; // default fallback

            if (typeof editingAnnouncement.targetAudience === 'string') {
                // If it's already a string, use it directly
                targetAudienceValue = editingAnnouncement.targetAudience;
                ...
                if (targetObj.userTypes?.length > 0) {
                ...
                } else if (targetObj.eligibilityCategories?.length > 0) {
                ...
                } else if (targetObj.categories?.length > 0) {
