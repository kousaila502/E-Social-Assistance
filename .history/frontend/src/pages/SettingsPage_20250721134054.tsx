  ...
  useEffect(() => {
    ...
    if (user?.preferences) {
      setNotificationSettings(prev => ({
        ...prev,
        email: { ...prev.email, ...user.preferences?.notifications?.email },
        sms: { ...prev.sms, ...user.preferences?.notifications?.sms },
        inApp: { ...prev.inApp, ...user.preferences?.notifications?.inApp },
      }));
