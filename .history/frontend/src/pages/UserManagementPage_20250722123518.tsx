...
// Update the review buttons:
<button
  onClick={() => handleFilterChange({ ...filters, accountStatus: 'pending_verification' })}
...
<button
  onClick={() => handleFilterChange({ ...filters, accountStatus: 'suspended' })}
