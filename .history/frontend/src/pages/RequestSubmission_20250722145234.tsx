...
const RequestSubmissionPage: React.FC = () => {
  ...
  const handleSubmit = async (formData: CreateDemandeData) => {
    ...
    try {
      ...
      const requestId = response.demande._id;

      // Upload documents if any
      if (documents.length > 0) {
        await requestService.uploadDocuments(requestId, documents);
      ...
      navigate(`${ROUTES.REQUEST_DETAILS.replace(':id', requestId)}`);
    } catch (error: any) {
  ...
  const handleSaveDraft = async (formData: Partial<CreateDemandeData>) => {
    ...
    try {
      // Create the request with required fields, others can be empty
    ...
    <MainLayout>
      <div className="max-w-4xl mx-auto">
        ...
        {user?.accountStatus !== 'active' && (
          <div className="mb-6 bg-red-50 border border-red-200 rounded-lg p-4">
            <div className="flex items-start">
              ...
              <div>
                <h3 className="text-sm font-medium text-red-800">Account Not Active</h3>
          ...
          <div className="mb-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
            <div className="flex items-start">
              ...
              <div>
                ...
                {user.eligibility.categories && user.eligibility.categories.length > 0 && (
                  <p className="text-sm text-blue-700 mt-1">
        ...
        <div className="mb-8 bg-gray-50 border border-gray-200 rounded-lg p-6">
          <h2 className="text-lg font-semibold text-gray-900 mb-4">Before You Submit</h2>
        ...
        <div className="mt-8 bg-gray-50 border border-gray-200 rounded-lg p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <h3 className="text-sm font-medium text-gray-900 mb-2">Processing Time</h3>
