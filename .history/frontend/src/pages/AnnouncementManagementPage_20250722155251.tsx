...
const AnnouncementManagementPage: React.FC = () => {
    ...
    const fetchStats = async () => {
        ...
        try {
            ...
            setStats({
                totalAnnouncements: response.statistics.totalAnnouncements,
                publishedAnnouncements: response.statistics.publishedAnnouncements,
                draftAnnouncements: response.statistics.draftAnnouncements,
                expiredAnnouncements: response.statistics.expiredAnnouncements,
                totalApplications: response.statistics.totalApplications,
                pendingApplications: response.statistics.pendingApplications,
                announcementsByType: response.statistics.announcementsByType.reduce((acc, item) => {
    ...
    return (
        <MainLayout>
            ...
            {/* TODO: Add CreateAnnouncementModal and AnnouncementDetailsModal */}
        </MainLayout>
    );
};
