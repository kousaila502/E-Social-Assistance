...
const requestService = {
  // 🔥 GET ALL REQUESTS - EXACT BACKEND ALIGNMENT
  getAll: async (params?: DemandeQueryParams): Promise<DemandesResponse> => {
    try {
      const response: AxiosResponse<DemandesResponse> = await api.get(
  ...
  // 🔥 GET DASHBOARD STATS - EXACT BACKEND ALIGNMENT
  getDashboardStats: async (): Promise<DashboardStatsResponse> => {
    try {
      const response: AxiosResponse<DashboardStatsResponse> = await api.get(
  ...
  // 🔥 GET REQUESTS BY STATUS - EXACT BACKEND ALIGNMENT
  ...
  // 🔥 CREATE REQUEST - EXACT BACKEND ALIGNMENT
  create: async (requestData: CreateDemandeData): Promise<MessageResponse> => {
    try {
  ...
  // 🔥 GET SINGLE REQUEST - EXACT BACKEND ALIGNMENT
  getById: async (id: string): Promise<DemandeResponse> => {
    try {
      const response: AxiosResponse<DemandeResponse> = await api.get(
  ...
  // 🔥 UPDATE REQUEST - EXACT BACKEND ALIGNMENT
  ...
  // 🔥 SUBMIT REQUEST - EXACT BACKEND ALIGNMENT
  ...
  // 🔥 REVIEW REQUEST - EXACT BACKEND ALIGNMENT (Admin/Case Worker only)
  ...
  // 🔥 ASSIGN REQUEST - EXACT BACKEND ALIGNMENT (Admin/Case Worker only)
  ...
  // 🔥 CANCEL REQUEST - EXACT BACKEND ALIGNMENT
