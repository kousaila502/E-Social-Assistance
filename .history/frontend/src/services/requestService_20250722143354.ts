...
const requestService = {
  ...
  getAll: async (params?: {
    ...
    try {
      ...
      const response: DemandesResponse = await api.get(url);
      return response;
    } catch (error: any) {
      throw error;
    }
  ...
  getDashboardStats: async (): Promise<DashboardStatsResponse> => {
    try {
      const response: DashboardStatsResponse = await api.get(API_CONFIG.ENDPOINTS.DEMANDES.DASHBOARD_STATS);
      return response;
    } catch (error: any) {
      throw error;
    }
  ...
  create: async (requestData: CreateDemandeData): Promise<DemandeResponse> => {
    try {
      const response: DemandeResponse = await api.post(API_CONFIG.ENDPOINTS.DEMANDES.CREATE, requestData);
      return response;
    } catch (error: any) {
      throw error;
    }
  ...
  getById: async (id: string): Promise<DemandeResponse> => {
    try {
      const response: DemandeResponse = await api.get(API_CONFIG.ENDPOINTS.DEMANDES.GET_BY_ID(id));
      return response;
    } catch (error: any) {
      throw error;
    }
  ...
  update: async (id: string, updateData: UpdateDemandeData): Promise<DemandeResponse> => {
    try {
      const response: DemandeResponse = await api.patch(API_CONFIG.ENDPOINTS.DEMANDES.UPDATE(id), updateData);
      return response;
    } catch (error: any) {
      throw error;
    }
  ...
  submit: async (id: string): Promise<{ message: string }> => {
    try {
      const response: { message: string } = await api.post(API_CONFIG.ENDPOINTS.DEMANDES.SUBMIT(id));
      return response;
    } catch (error: any) {
      throw error;
    }
  ...
  review: async (id: string, reviewData: ReviewDemandeData): Promise<{ message: string }> => {
    try {
      const response: { message: string } = await api.patch(API_CONFIG.ENDPOINTS.DEMANDES.REVIEW(id), reviewData);
      return response;
    } catch (error: any) {
      throw error;
    }
  ...
  assign: async (id: string, assignedTo: string): Promise<{ message: string }> => {
    try {
      const response: { message: string } = await api.patch(API_CONFIG.ENDPOINTS.DEMANDES.ASSIGN(id), {
        assignedTo
      });
      return response;
    } catch (error: any) {
  ...
  cancel: async (id: string, reason?: string): Promise<{ message: string }> => {
    try {
      const response: { message: string } = await api.patch(API_CONFIG.ENDPOINTS.DEMANDES.CANCEL(id), {
        reason
      });
      return response;
    } catch (error: any) {
  ...
  addComment: async (id: string, commentData: AddCommentData): Promise<{ message: string }> => {
    try {
      const response: { message: string } = await api.post(API_CONFIG.ENDPOINTS.DEMANDES.ADD_COMMENT(id), commentData);
      return response;
    } catch (error: any) {
      throw error;
    }
  ...
  uploadDocuments: async (id: string, files: File[]): Promise<{ message: string; documents: any[] }> => {
    try {
      ...
      const response: { message: string; documents: any[] } = await api.post(API_CONFIG.ENDPOINTS.DEMANDES.UPLOAD_DOCUMENTS(id), formData, {
        headers: {
  ...
  requestDocuments: async (
    ...
    try {
      const response: { message: string } = await api.post(
  ...
  export: async (format: 'csv' | 'json' = 'csv'): Promise<Blob> => {
    try {
      const response: Blob = await api.get(`${API_CONFIG.ENDPOINTS.DEMANDES.EXPORT}?format=${format}`, {
        responseType: 'blob'
      });
      return response;
    } catch (error: any) {
