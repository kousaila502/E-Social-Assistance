...
class AnalyticsService {
  ...
  private async getUserAnalytics() {
    const response = await fetch(`${apiConfig.API_BASE_URL}/users/dashboard-stats`, {
      credentials: 'include'
    });
  ...
  private async getRequestAnalytics() {
    const response = await fetch(`${apiConfig.API_BASE_URL}/demandes/dashboard-stats`, {
      credentials: 'include'
    });
  ...
  private async getPaymentAnalytics() {
    const response = await fetch(`${apiConfig.API_BASE_URL}/payments/dashboard-stats`, {
      credentials: 'include'
    });
  ...
  private async getBudgetAnalytics() {
    const response = await fetch(`${apiConfig.API_BASE_URL}/budget-pools/dashboard-stats`, {
      credentials: 'include'
    });
  ...
  private async getAnnouncementAnalytics() {
    const response = await fetch(`${apiConfig.API_BASE_URL}/announcements/stats`, {
      credentials: 'include'
    });
  ...
  private combineAnalytics(data: any): AnalyticsDashboard {
    ...
    const performance: PerformanceMetrics = {
      ...
      budgetUtilization: {
        rate: budgetStats.statistics?.avgUtilization || 0,
